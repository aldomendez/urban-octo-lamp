do ()->
  ...
  runOnjQueryLoad ()->
    ...
    window.codes = codes = [
      {code:'UDTL-16C',items:['ROUTER-LD-SUBASSY','ROUTER-PD-SUBASSY','UDTL291OSA','BS-PD-SUBASSY','SILICON-SLAB-SUBASSY','HOLDER-DEFLECTOR-3','ROUTER-HEATER-SUBASY','TEC-PACKAGE-SUBASSY','LENS-P210-SUB-ASSY']}
    ]
    $('body').html('')
